...
eachGuest(guests: invitedGuests)
/*:
...
//write the function here
func returnAdult(guests: [Guest]) -> [Guest] {
    var adults: Array<Guest>
    adults = []
    for guest in guests {
        if guest.age >= 18 {
            adults.append(guest)
...
print(returnAdult(guests: invitedGuests))
